// $Id: hierarchical_select.js,v 1.80.2.16 2010/03/01 00:39:17 wimleers Exp $
...
Drupal.HierarchicalSelect.update = function(hsid, updateType, settings) {
  ...
  var url = Drupal.settings.HierarchicalSelect.url;
  ...
  var ajaxOptions = {
    ...
    error: function (XMLHttpRequest, textStatus, errorThrown) {
      ...
      Drupal.HierarchicalSelect.throwError(hsid, 'Received an invalid response from the server.');
    },
